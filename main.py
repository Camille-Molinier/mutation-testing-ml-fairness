...
def main():
    ...
    for i, model in enumerate(models):
        ...
        make_history_figs(hist,
                          ...
                          save_path=f'./dat/fig/adult/{protected_attribute}/{names[i]}.png',
                          display=False)

        make_multi_stats(hist,
                         mutations,
                         model_name=f'{names[i]}',
                         p_val_save_path=f'./dat/fig/adult/{protected_attribute}/{names[i]}_p-values.png',
                         effect_size_save_path=f'./dat/fig/adult/{protected_attribute}/{names[i]}_effect_sizes.png',
                         display=False)
